...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2022 at 08:13 PM
...
--
-- Table structure for table `tbl_students_0580`
--

CREATE TABLE `tbl_students_0580` (
  `id` int(3) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0580`
--

INSERT INTO `tbl_students_0580` (`id`, `nim`, `nama`, `jenis_kelamin`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0580`
--
ALTER TABLE `tbl_students_0580`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_students_0580`
--
ALTER TABLE `tbl_students_0580`
